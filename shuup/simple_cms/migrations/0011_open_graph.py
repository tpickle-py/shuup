        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="The title of your object as it should appear within the graph, e.g. The Rock.",
                        max_length=100,
                        verbose_name="Title",
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="A high-level section name, e.g. Technology. Only applicable when type is Article.",
                        max_length=256,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Tag words associated with this article. Only applicable when type is Article.",
                        max_length=256,
                        verbose_name="Tags",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="The name of the author for the article. Only applicable when type is Article.",
                        max_length=100,
