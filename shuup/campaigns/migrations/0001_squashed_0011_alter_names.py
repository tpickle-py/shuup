    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "active",
                    models.BooleanField(
                        help_text="Check this if the campaign is currently active. Please also set a start and end date.",
                        verbose_name="active",
                        default=False,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="The date and time the campaign starts. This is only applicable if the campaign is marked as active.",
                        null=True,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="The date and time the campaign ends. This is only applicable if the campaign is marked as active.",
                        null=True,
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Limit the amount of usages per a single customer.",
                        null=True,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Set the absolute limit of usages for this coupon. If the limit is zero (0) coupon cannot be used.",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operator",
                    enumfields.fields.EnumIntegerField(
                        enum=shuup.campaigns.models.basket_conditions.ComparisonOperator,
                ...
                (
                    "quantity",
                    models.PositiveIntegerField(verbose_name="quantity", default=1),
                ),
                (
                    "categories",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="If the customer has even a single product in the basket from these categories this rule won't match thus the campaign cannot be applied to the basket.",
                        to="shuup.Category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contacts",
                    models.ManyToManyField(to="shuup.Contact", verbose_name="contacts"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "per_line_discount",
                    models.BooleanField(
                        help_text="Uncheck this if you want to give discount for each matched product.",
                ...
                (
                    "products",
                    models.ManyToManyField(to="shuup.Product", verbose_name="product"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hour_end",
                    models.TimeField(
                        help_text="12pm is considered noon and 12am as midnight. End time is not considered match.",
