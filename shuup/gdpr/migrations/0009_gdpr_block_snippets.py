    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text="Select the snippets that shouldn't be injected if the cookie is not consented.",
                related_name="blocked_gdpr_cookies",
                to="shuup_xtheme.Snippet",
                verbose_name="Snippets to block if not consented",
            ),
        ),
    ]
