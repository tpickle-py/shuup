...
get_visibility_errors = Signal(
    providing_args=["shop_product", "customer"], use_caching=True
)
...
shipment_created_and_processed = Signal(
    providing_args=["order", "shipment"], use_caching=True
)
...
order_status_changed = Signal(
    providing_args=["order", "old_status", "new_status"], use_caching=True
)
user_reset_password_requested = Signal(
    providing_args=["shop", "user", "reset_domain_url", "reset_url_name"]
)
...
#:
stocks_updated = Signal(
    providing_args=["shops", "product_ids", "supplier"], use_caching=True
)
