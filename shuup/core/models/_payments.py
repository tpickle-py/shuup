...
class AbstractPayment(MoneyPropped, models.Model):
    ...
    gateway_id = models.CharField(
        max_length=32, verbose_name=_("gateway ID")
    ...
    foreign_amount_value = MoneyValueField(
        default=None, blank=True, null=True, verbose_name=_("foreign amount")
    )
    foreign_currency = CurrencyField(
        default=None, blank=True, null=True, verbose_name=_("foreign amount currency")
    )
