        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "queue",
                    models.CharField(
                        db_index=True, max_length=128, verbose_name="queue name"
                    ),
                ),
                (
                    "identifier",
                    models.CharField(
                        max_length=128, unique=True, verbose_name="task identifier"
                    ),
                ),
                (
                    "created_on",
                ...
                (
                    ...
                    jsonfield.fields.JSONField(
                        blank=True, null=True, verbose_name="task arguments"
                    ),
                ),
                (
                    "shop",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    jsonfield.fields.JSONField(
                        blank=True, null=True, verbose_name="results"
                    ),
                ),
                (
                    "error_log",
