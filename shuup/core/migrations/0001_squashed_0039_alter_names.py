    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "identifier",
                    shuup.core.fields.InternalIdentifierField(
                        unique=True,
                        blank=False,
                        editable=False,
                        max_length=64,
                ...
                (
                    "searchable",
                    models.BooleanField(
                        help_text="Searchable attributes will be used for product lookup when customers search your store.",
                ...
                (
                    ...
                    enumfields.fields.EnumIntegerField(
                        help_text="The attribute data type. Attribute values can be set on the product editor page.",
                        verbose_name="type",
                ...
                (
                    "visibility_mode",
                    enumfields.fields.EnumIntegerField(
                        help_text="Select the attribute visibility setting. Attributes can be shown on the product detail page or can be used to enhance product search results.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The attribute name. Product attributes can be used to list the various features of a product and can be shown on the product detail page. The product attributes for a product are determined by the product type and can be set on the product editor page.",
                        verbose_name="name",
                        max_length=64,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(verbose_name="title", max_length=64, blank=True),
                ),
                ...
                (
                    "prices_include_tax",
                    models.BooleanField(verbose_name="prices include tax"),
                ),
                (
                    "product_count",
                    models.IntegerField(verbose_name="product_count", default=0),
                ),
                (
                    "creator",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    enumfields.fields.EnumIntegerField(
                        help_text="Here you can choose whether or not you want the category to be visible in your store.",
                        db_index=True,
                        verbose_name="status",
                ...
                (
                    "ordering",
                    models.IntegerField(
                        help_text="You can set the order of categories in your store numerically.",
                ...
                (
                    "visibility",
                    enumfields.fields.EnumIntegerField(
                        help_text="You can choose to limit who sees your category based on whether they are logged in or if they are  part of a customer group.",
                        db_index=True,
                ...
                (
                    "visible_in_menu",
                    models.BooleanField(
                        help_text="Check this if this category should be visible in menu.",
                ...
                (
                    ...
                    mptt.fields.TreeForeignKey(
                        help_text="If your category is a sub-category of another category, you can link them here.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="Give your product category a detailed description. This will help shoppers find your products under that category in your store and on the web.",
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="Enter a URL slug for your category. This is what your product category page URL will be. A default will be created using the category name.",
                        blank=True,
                        verbose_name="slug",
                        null=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        help_text="Check this if the contact is an active customer.",
                        verbose_name="active",
                        db_index=True,
                        default=True,
                    ),
                ...
                (
                    "_language",
                    shuup.core.fields.LanguageField(
                        help_text="The primary language to be used in all communications with the contact.",
                ...
                (
                    ...
                    timezone_field.fields.TimeZoneField(
                        help_text="The timezone in which the contact resides. This can be used to target the delivery of promotional materials at a particular time.",
                        blank=True,
                ...
                (
                    "prefix",
                    models.CharField(
                        help_text="The name prefix of the contact. For example, Mr, Mrs, Dr, etc.",
                ...
                (
                    "suffix",
                    models.CharField(
                        help_text="The name suffix of the contact. For example, Sr, Jr, etc.",
                ...
                (
                    "email",
                    models.EmailField(
                        help_text="The email that will receive order confirmations and promotional materials (if permitted).",
                        verbose_name="email",
                        max_length=256,
                        blank=True,
                    ),
                ...
                (
                    "merchant_notes",
                    models.TextField(
                        help_text="Enter any private notes for this customer that are only accessible in Shuup admin.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hide_prices",
                    models.NullBooleanField(verbose_name="hide prices", default=None),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        help_text="The number of decimal places supported by this currency.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The customer tax group name. Customer tax groups can be used to control how taxes are applied to a set of customers. ",
                        verbose_name="name",
                        max_length=100,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "decimals",
                    models.PositiveSmallIntegerField(
                        help_text="The number of decimal places to use for values in the display unit.  The internal values are still rounded based on settings of the internal unit.",
                        verbose_name="decimal places",
                        default=0,
                    ),
                ),
                ...
                (
                    "allow_bare_number",
                    models.BooleanField(
                        help_text="If true, values of this unit can be shown without the symbol occasionally.  Usually wanted if the unit is a piece, so that product listings can show just '$5.95' rather than '$5.95 per pc.'.",
                ...
                (
                    "default",
                    models.BooleanField(
                        help_text="Use this display unit by default when displaying values of the internal unit.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "symbol",
                    models.CharField(
                        help_text="An abbreviated name of the display unit, e.g. 'g'.",
                        verbose_name="symbol",
                        max_length=50,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="The order line text to display when this behavior is applied.",
                        verbose_name="description",
                        max_length=100,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prefix",
                    models.CharField(
                        help_text="The name prefix. For example, Mr, Mrs, Ms, Dr, etc.",
                        verbose_name="name prefix",
                        max_length=64,
                        blank=True,
                    ),
                ...
                (
                    "name_ext",
                    models.CharField(
                        help_text="Any other text to display along with the address. This could be department names (for companies) or titles (for people).",
                ...
                (
                    "tax_number",
                    models.CharField(
                        help_text="The business tax number. For example, EIN in US or VAT code in Europe.",
            ...
            bases=(
                ...
                shuup.core.utils.name_mixin.NameMixin,
                models.Model,
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_on",
                    models.DateTimeField(verbose_name="added", auto_now_add=True),
                ),
                (
                    "identifier",
                    shuup.core.fields.InternalIdentifierField(
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter the manufacturer’s name. Products can be filtered by the manufacturer and can be useful for inventory and stock management.",
                        verbose_name="name",
                        max_length=128,
                    ),
                ),
                (
                    "url",
                    models.CharField(
                        help_text="Enter the URL of the product manufacturer if you would like customers to be able to visit the manufacturer's website.",
                        verbose_name="URL",
                        max_length=128,
                        null=True,
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(verbose_name="key", unique=True, max_length=32),
                ),
                (
                    "reference_number",
                    models.CharField(
                ...
                (
                    "phone",
                    models.CharField(verbose_name="phone", max_length=64, blank=True),
                ),
                (
                    "email",
                    models.EmailField(
                ...
                (
                    "customer_comment",
                    models.TextField(verbose_name="customer comment", blank=True),
                ),
                (
                    "admin_comment",
                    models.TextField(verbose_name="admin comment/notes", blank=True),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "verified",
                    models.BooleanField(verbose_name="verified", default=False),
                ),
                (
                    "extra_data",
                    jsonfield.fields.JSONField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gateway_id",
                    models.CharField(verbose_name="gateway ID", max_length=32),
                ),
                (
                    "payment_identifier",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enabled",
                    models.BooleanField(
                        help_text="Check this if this service is selectable on checkout.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The payment method name. This name is shown to customers on checkout.",
                        verbose_name="name",
                        max_length=100,
                    ),
                ),
                (
                    "description",
                    models.CharField(
                        help_text="The payment method description. This description is shown to customers on checkout.",
                        verbose_name="description",
                        max_length=500,
                        blank=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("module", models.CharField(verbose_name="module", max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modified_on",
                    models.DateTimeField(verbose_name="modified on", auto_now=True),
                ),
                (
                    "deleted",
                    models.BooleanField(
                ...
                (
                    "stock_behavior",
                    enumfields.fields.EnumIntegerField(
                        help_text="Set to stocked if inventory should be managed within Shuup.",
                        verbose_name="stock",
                ...
                (
                    "shipping_mode",
                    enumfields.fields.EnumIntegerField(
                        help_text="Set to shipped if the product requires shipment.",
                ...
                (
                    "sku",
                    models.CharField(
                        help_text="Enter a SKU (Stock Keeping Unit) number for your product. This is a product identification code that helps you track it through your inventory. People often use the number by the barcode on the product, but you can set up any numerical system you want to keep track of products.",
                        verbose_name="SKU",
                        unique=True,
                        db_index=True,
                        max_length=128,
                ...
                (
                    "gtin",
                    models.CharField(
                        help_text="You can enter a Global Trade Item Number. This is typically a 14 digit identification number for all of your trade items. It can often be found by the barcode.",
                        verbose_name="GTIN",
                        max_length=40,
                        blank=True,
                    ),
                ...
                (
                    "barcode",
                    models.CharField(
                        help_text="You can enter the barcode number for your product. This is useful for inventory/stock tracking and analysis.",
                ...
                (
                    "width",
                    shuup.core.fields.MeasurementField(
                        help_text="Set the measured width of your product or product packaging. This will provide customers with your product size and help with calculating shipping costs.",
                        unit="mm",
                        decimal_places=9,
                        max_digits=36,
                ...
                (
                    "height",
                    shuup.core.fields.MeasurementField(
                        help_text="Set the measured height of your product or product packaging. This will provide customers with your product size and help with calculating shipping costs.",
                        unit="mm",
                        decimal_places=9,
                        max_digits=36,
                ...
                (
                    "depth",
                    shuup.core.fields.MeasurementField(
                        help_text="Set the measured depth or length of your product or product packaging. This will provide customers with your product size and help with calculating shipping costs.",
                        unit="mm",
                        decimal_places=9,
                        max_digits=36,
                ...
                (
                    "net_weight",
                    shuup.core.fields.MeasurementField(
                        help_text="Set the measured weight of your product WITHOUT its packaging. This will provide customers with your product weight.",
                        unit="g",
                        decimal_places=9,
                        max_digits=36,
                ...
                (
                    "manufacturer",
                    models.ForeignKey(
                        help_text="Select a manufacturer for your product. These are defined in Products Settings - Manufacturers",
                        on_delete=django.db.models.deletion.PROTECT,
                        to="shuup.Manufacturer",
                        blank=True,
                        verbose_name="manufacturer",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(verbose_name="untranslated value", blank=True),
                ),
                (
                    "attribute",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(verbose_name="translated value", blank=True),
                ),
                (
                    "master",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    enumfields.fields.EnumIntegerField(
                        verbose_name="type", enum=shuup.core.models.ProductCrossSellType
                    ),
                ),
                (
                    "product1",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kind",
                    enumfields.fields.EnumIntegerField(
                        help_text="Select what type the media is. It can either be a normal file, part of the documentation, or a sample.",
                        db_index=True,
                        verbose_name="kind",
                ...
                (
                    "external_url",
                    models.URLField(
                        help_text="Enter URL to external file. If this field is filled, the selected media doesn't apply.",
                        verbose_name="URL",
                        null=True,
                        blank=True,
                    ),
                ...
                (
                    "ordering",
                    models.IntegerField(
                        help_text="You enter the numerical order that your image will be displayed on your product page.",
                        verbose_name="ordering",
                        default=0,
                    ),
                ),
                ...
                (
                    "public",
                    models.BooleanField(
                        help_text="Check this if you would like the image shown on your product page. Checked by default.",
                ...
                (
                    "purchased",
                    models.BooleanField(
                        help_text="Select this if you would like the product media shown for completed purchases.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Choose a title for your product media. This will help it be found in your store and on the web.",
                        verbose_name="title",
                        max_length=128,
                        blank=True,
                    ),
                ...
                (
                    "description",
                    models.TextField(
                        help_text="Write a description for your product media. This will help it be found in your store and on the web.",
                        verbose_name="description",
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="To make your product stand out, give it an awesome description. This is what will help your shoppers learn about your products. It will also help shoppers find them in the store and on the web.",
                        verbose_name="description",
                        blank=True,
                    ),
                ),
                (
                    "short_description",
                    models.CharField(
                        help_text="Enter a short description for your product. The short description will be used to get the attention of your customer with a small but precise description of your product.",
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="Enter a URL Slug for your product. This is what your product page URL will be. A default will be created using the product name.",
                        blank=True,
                        verbose_name="slug",
                        max_length=255,
                        null=True,
                ...
                (
                    "keywords",
                    models.TextField(
                        help_text="You can enter keywords that describe your product. This will help your shoppers learn about your products. It will also help shoppers find them in the store and on the web.",
                ...
                (
                    "variation_name",
                    models.CharField(
                        help_text="You can enter a name for the variation of your product. This could be for example different colors or versions.",
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text="Select attributes that go with your product type. These are defined in Products Settings – Attributes.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Enter a descriptive name for your product type. Products and attributes for products of this type can be found under this name.",
                        verbose_name="name",
                        max_length=64,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The sales unit name to use for products (For example, 'pieces' or 'units'). Sales units can be set for each product through the product editor view.",
                        verbose_name="name",
                        max_length=128,
                    ),
                ),
                (
                    "symbol",
                    models.CharField(
                        help_text="An abbreviated name for this sales unit that is shown throughout admin and order invoices.",
                        verbose_name="symbol",
                        max_length=128,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(verbose_name="title", max_length=255, blank=True),
                ),
                (
                    "address",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enabled",
                    models.BooleanField(
                        help_text="Check this if this service provider can be used when placing orders",
                        verbose_name="enabled",
                        default=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The shipping method name. This name is shown to customers on checkout.",
                        verbose_name="name",
                        max_length=100,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "domain",
                    models.CharField(
                        help_text="Your shop domain name. Use this field to configure the URL that is used to visit your site. Note: this requires additional configuration through your internet domain registrar.",
                        unique=True,
                        blank=True,
                        verbose_name="domain",
                        max_length=128,
                ...
                (
                    "status",
                    enumfields.fields.EnumIntegerField(
                        help_text="Your shop status. Disable your shop if it is no longer in use.",
                        verbose_name="status",
                ...
                (
                    "currency",
                    shuup.core.fields.CurrencyField(
                        help_text="The primary shop currency. This is the currency used when selling your products.",
                        verbose_name="currency",
                        max_length=4,
                ...
                (
                    "prices_include_tax",
                    models.BooleanField(
                        help_text="This option defines whether product prices entered in admin include taxes. Note this behavior can be overridden with contact group pricing.",
                ...
                (
                    "maintenance_mode",
                    models.BooleanField(
                        help_text="Check this if you would like to make your shop temporarily unavailable while you do some shop maintenance.",
                ...
                (
                    "favicon",
                    filer.fields.image.FilerImageField(
                        help_text="Shop favicon. Will be shown next to the address on browser.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visibility_limit",
                    enumfields.fields.EnumIntegerField(
                        help_text="Select whether you want your product to have special limitations on its visibility in your store. You can make products visible to all, visible to only logged in users, or visible only to certain customer groups.",
                        db_index=True,
                        verbose_name="visibility limitations",
                ...
                (
                    "backorder_maximum",
                    shuup.core.fields.QuantityField(
                        help_text="The number of units that can be purchased after the product is out of stock. Set to blank for product to be purchasable without limits.",
                        decimal_places=9,
                        max_digits=36,
                        blank=True,
                ...
                (
                    "purchase_multiple",
                    shuup.core.fields.QuantityField(
                        help_text="Set this if the product needs to be purchased in multiples. For example, if the purchase multiple is set to 2, then customers are required to order the product in multiples of 2.",
                ...
                (
                    ...
                    models.BooleanField(
                        help_text="Check this if you want to limit your product to use only select payment methods. You can select the payment method(s) in the field below.",
                ...
                (
                    "default_price_value",
                    shuup.core.fields.MoneyValueField(
                        help_text="This is the default individual base unit (or multi-pack) price of the product. All discounts or coupons will be based off of this price.",
                        decimal_places=9,
                        max_digits=36,
                        blank=True,
                ...
                (
                    "minimum_price_value",
                    shuup.core.fields.MoneyValueField(
                        help_text="This is the default price that the product cannot go under in your store, despite coupons or discounts being applied. This is useful to make sure your product price stays above cost.",
                        decimal_places=9,
                        max_digits=36,
                        blank=True,
                ...
                (
                    "categories",
                    models.ManyToManyField(
                        help_text="Add secondary categories for your product. These are other categories that your product fits under and that it can be found by in your store.",
                ...
                (
                    "payment_methods",
                    models.ManyToManyField(
                        help_text="Select the payment methods you would like to limit the product to using. These are defined in Settings - Payment Methods.",
                ...
                (
                    "primary_category",
                    models.ForeignKey(
                        help_text="Choose the primary category for your product. This will be the main category for classification in the system. Your product can be found under this category in your store. Categories are defined in Products Settings - Categories.",
                ...
                (
                    "shipping_methods",
                    models.ManyToManyField(
                        help_text="Select the shipping methods you would like to limit the product to using. These are defined in Settings - Shipping Methods.",
                ...
                (
                    "shop_primary_image",
                    models.ForeignKey(
                        help_text="Click this to set this image as the primary display image for your product.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The shop name. This name is displayed throughout admin.",
                        verbose_name="name",
                        max_length=64,
                    ),
                ),
                (
                    "public_name",
                    models.CharField(
                        help_text="The public shop name. This name is displayed in the store front and in any customer email correspondence.",
                        verbose_name="public name",
                        max_length=64,
                    ),
                ),
                (
                    "maintenance_message",
                    models.CharField(
                        help_text="The message to display to customers while your shop is in maintenance mode.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sku",
                    models.CharField(verbose_name="SKU", db_index=True, max_length=128),
                ),
                (
                    "alert_limit",
                    models.IntegerField(verbose_name="alert limit", default=0),
                ),
                (
                    "physical_count",
                    shuup.core.fields.QuantityField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    enumfields.fields.EnumIntegerField(
                        help_text="The supplier type indicates whether the products are supplied through an internal supplier or an external supplier.",
                ...
                (
                    "stock_managed",
                    models.BooleanField(
                        help_text="Check this if this supplier will be used to manage the inventory of stocked products.",
                ...
                (
                    "module_identifier",
                    models.CharField(
                        help_text="Select the supplier module to use for this supplier. Supplier modules define the rules by which inventory is managed.",
                        verbose_name="module",
                        max_length=64,
                        blank=True,
                    ),
                ...
                (
                    "shops",
                    models.ManyToManyField(
                        help_text="You can select which shops the supplier is available to.",
                        verbose_name="shops",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount_value",
                    shuup.core.fields.MoneyValueField(
                        help_text="The flat amount of the tax. Mutually exclusive with percentage rates.",
                        decimal_places=9,
                        max_digits=36,
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enabled",
                    models.BooleanField(
                        help_text="Check this if this tax class is active and valid.",
                        verbose_name="enabled",
                        default=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The tax class name. Tax classes are used to control how taxes are applied to products.",
                        verbose_name="name",
                        max_length=100,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The tax name. This is shown in order lines in order invoices and confirmations.",
                        verbose_name="name",
                        max_length=124,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_value",
                    shuup.core.fields.MeasurementField(
                        help_text="The minimum weight, in grams, for this price to apply.",
                        unit="g",
                        decimal_places=9,
                        max_digits=36,
                        blank=True,
                ...
                (
                    "max_value",
                    shuup.core.fields.MeasurementField(
                        help_text="The maximum weight, in grams, before this price no longer applies.",
                        unit="g",
                        decimal_places=9,
                        max_digits=36,
                        blank=True,
                ...
                (
                    "price_value",
                    shuup.core.fields.MoneyValueField(
                        help_text="The cost to apply to this service when the weight criteria is met.",
                        decimal_places=9,
                        max_digits=36,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            bases=(
                "shuup.servicebehaviorcomponent",
                parler.models.TranslatableModelMixin,
                models.Model,
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_value",
                    shuup.core.fields.MoneyValueField(
                        help_text="The cost to apply to this service if the total price is below the waive limit.",
                        decimal_places=9,
                        max_digits=36,
                    ),
                ),
                (
                    "waive_limit_value",
                    shuup.core.fields.MoneyValueField(
                        help_text="The total price of products at which this service cost is waived.",
                        decimal_places=9,
                        max_digits=36,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_weight",
                    models.DecimalField(
                        help_text="The minimum weight required for this service to be available.",
                        decimal_places=6,
                        max_digits=36,
                        blank=True,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text="List your suppliers here. Suppliers can be found in Product Settings - Suppliers.",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text="Select the groups you would like to make your product visible for. These groups are defined in Contacts Settings - Contact Groups.",
        ...
        migrations.AddField(
            ...
            name="tax_class",
            field=models.ForeignKey(
                help_text="The tax class to use for this service. Tax classes are defined in Settings - Tax Classes.",
                on_delete=django.db.models.deletion.PROTECT,
                to="shuup.TaxClass",
                verbose_name="tax class",
            ),
        ...
        migrations.AddField(
            ...
            name="shops",
            field=models.ManyToManyField(
                help_text="Select which shops you would like the product media to be visible in.",
                verbose_name="shops",
                to="shuup.Shop",
        ...
        migrations.AddField(
            ...
            name="sales_unit",
            field=models.ForeignKey(
                help_text="Select a sales unit for your product. This is shown in your store front and is used to determine whether the product can be purchased using fractional amounts. Sales units are defined in Products - Sales Units.",
                on_delete=django.db.models.deletion.PROTECT,
                to="shuup.SalesUnit",
                blank=True,
                verbose_name="sales unit",
        ...
        migrations.AddField(
            ...
            name="tax_class",
            field=models.ForeignKey(
                help_text="Select a tax class for your product. The tax class is used to determine which taxes to apply to your product. Tax classes are defined in Settings - Tax Classes. The rules by which taxes are applied are defined in Settings - Tax Rules.",
                on_delete=django.db.models.deletion.PROTECT,
                to="shuup.TaxClass",
                verbose_name="tax class",
            ),
        ...
        migrations.AddField(
            ...
            name="internal_unit",
            field=models.ForeignKey(
                help_text="The sales unit that this display unit is linked to.",
        ...
        migrations.AddField(
            ...
            name="tax_group",
            field=models.ForeignKey(
                help_text="Select the contact tax group to use for this contact. Tax groups can be used to customize the tax rules the that apply to any of this contacts orders. Tax groups are defined in Settings - Customer Tax Groups and can be applied to tax rules in Settings - Tax Rules",
                on_delete=django.db.models.deletion.PROTECT,
                to="shuup.CustomerTaxGroup",
                blank=True,
        ...
        migrations.AddField(
            ...
            name="shops",
            field=models.ManyToManyField(
                help_text="You can select which shops the category is visible in.",
                verbose_name="shops",
        ...
        migrations.AddField(
            ...
            name="groups",
            field=models.ManyToManyField(
                help_text="The contact groups for which this service is available.",
                verbose_name="groups",
                to="shuup.ContactGroup",
            ),
        ),
