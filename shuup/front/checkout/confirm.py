...
class ConfirmForm(forms.Form):
    ...
    accept_terms = forms.BooleanField(required=True, label=_("I accept the terms and conditions"))
    marketing = forms.BooleanField(required=False, label=_("I want to receive marketing material"), initial=False)
