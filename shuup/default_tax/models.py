...
class TaxRule(models.Model):
    enabled = models.BooleanField(
        ...
        db_index=True,
        help_text=_("Enable this if this tax rule is active."),
    )
    tax_classes = models.ManyToManyField(
        TaxClass,
        verbose_name=_("tax classes"),
        help_text=_("Tax classes of the items to be taxed"),
    )
    ...
    tax = models.ForeignKey(
        ...
        verbose_name=_("tax"),
        help_text=_("The tax to apply when this rule is applied."),
    )
