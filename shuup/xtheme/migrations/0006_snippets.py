            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=20,
                        verbose_name="snippet type",
                    ),
                ),
                ("snippet", models.TextField(verbose_name="snippet")),
                (
                    "themes",
                    shuup.core.fields.SeparatedValuesField(
                        blank=True,
                        help_text="Select the themes that will have this snippet injected. Leave the field blank to inject in all themes.",
                        null=True,
                        verbose_name="themes",
                    ),
                ),
